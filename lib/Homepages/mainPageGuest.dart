...
import 'package:interactive_map/profile/guest_profile.dart';

class WelcomePageGuest extends StatelessWidget {
  const WelcomePageGuest({Key? key}) : super(key: key); // SDK-safe
  ...
  Widget build(BuildContext context) {
    final tabs = <TabSpec>[
      ...
      TabSpec(
        ...
        title: "الملف",
        builder: (goTo, indexOf) => const GuestProfilePage(),
      ),
    ];
